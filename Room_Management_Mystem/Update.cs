        ...
        private void button1_Click(object sender, EventArgs e)
        {
            switch (DBHelper.target)
            {
                case "student":
                    ...
                    stu.update(DBHelper.NUM, textBox1.Text, textBox2.Text, textBox3.Text, textBox4.Text, textBox5.Text);
                    break;
                case "teacher":
                    Teacher tea = new Teacher();
                    tea.update(DBHelper.NUM, textBox1.Text, textBox2.Text, textBox3.Text, textBox4.Text, textBox5.Text);
                    break;
                case "room":            
                    Room rom = new Room();
                    rom.update(DBHelper.NUM, textBox1.Text, textBox2.Text, textBox3.Text, textBox4.Text, textBox5.Text);
                    break;
                default:
                    break;
            }
